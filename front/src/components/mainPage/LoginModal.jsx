  ...
  async function registerAction(event){
    ...
    return(
        <div className="container">
              <div className="modal fade modal-lg z-index-1000" id={`staticBackdrop${props.id}`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                          ...
                          <div className="modal-body">
                              <nav>
                                <div className="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                                  <button className="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target={`#nav-home${props.id}`} type="button" role="tab" aria-controls="nav-home" aria-selected="true">Авторизация</button>
                                  <button className="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target={`#nav-profile${props.id}`} type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Регистрация</button>
                                </div>
                              </nav>
                              <div className="tab-content text-dark p-5" id="nav-tabContent">
                                <div className="tab-pane fade show active" id={`nav-home${props.id}`} role="tabpanel" aria-labelledby="nav-home-tab" tabIndex="0">
                                  <form>
                                    <div className="mb-3">
                                ...
                                <div className="tab-pane fade" id={`nav-profile${props.id}`} role="tabpanel" aria-labelledby="nav-profile-tab" tabIndex="0">
                                  <form>
                                  <div className="mb-3">
